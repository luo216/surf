...
static Parameter defconfig[ParameterLast] = {
	...
	[ProxyIgnoreHosts]    =       { { .v = (char *[]){ "chatglm.cn", "bilibili.com", "bing.com", "localhost", NULL } }, },
	[ProxyMode]           =       { { .i = NoProxy }, },
	[ProxyUrl]            =       { { .v = (char *) "socks://localhost:2334" }, },
	[RunInFullscreen]     =       { { .i = 0 },     },
	[ScrollBars]          =       { { .i = 1 },     },
	[ShowIndicators]      =       { { .i = 1 },     },
	[SiteQuirks]          =       { { .i = 1 },     },
...
#define SETPROP_GO(r, s, p) { \
        .v = (const char *[]){ "/bin/sh", "-c", \
             ...
             "      -e 's/\\\\\\(.\\)/\\1/g')\" " \
             "| cat ~/.surf/bookmarks.txt | rofi -dmenu -p '"p"' -w $1)\" " \
